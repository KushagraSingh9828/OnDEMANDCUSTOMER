...
import 'package:odsa/screens/auth/resetpassword.dart';
...
class ForgotPasswordOtp extends StatefulWidget {
  ...
  ForgotPasswordOtp({Key? key, required this.email}) : super(key: key);
    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (resp.status == true) {
        ...
        Navigator.of(context).push(MaterialPageRoute(
            builder: (BuildContext contex) => ResetPassword(
                  email: widget.email,
                )));
      } else {
        setState(() {
