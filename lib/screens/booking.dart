                            ...
                            Row(
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                      ...
                                      child: Icon(Icons.arrow_drop_up,color:darkPrimary,size: 30)
                                  ),
                                ]),
                            Flexible(
                              child: Padding(
                                                        ...
                                                        child: Column(
                                                            children: [
                                                              ...
                                                              Container(
                                                                ...
                                                                decoration: BoxDecoration(border: Border.all(color: Colors.black, width: 0.5), borderRadius: BorderRadius.circular(10), color: const Color(0xffFFFFFF)),
                                                                height: 50,
                                                                child: TextButton(
                                                                  onPressed: () {
                                                                    loadCameraAssets();
                        ...
                        child: Row(
                            ...
                            children: [
                              ...
                              GestureDetector(
                                ...
                                child: Icon(Icons.arrow_drop_down,color:darkPrimary,size: 30),
                              ),
                            ]),
                      ),
                    ),
...
// ignore: unused_catch_clause, empty_catches
  ...
  loadAssets() async {
    ...
    try {
      ...
      setState(() {
        // images = resultList;
        for (int i = 0; i < resultList.length==3; i++) {
